...
namespace MSG {
    ...
    MessageString FACTION_NAME_TOO_LONG = "FACTION NAME TOO LONG";

    MessageString SERVER_SHUT_DOWN_ON_PROGRAM_REQUEST = "SERVER SHUT DOWN ON PROGRAM REQUEST";

    MessageString UNAUTHORIZED = "UNAUTHORISED";

    MessageString HOST_HAS_QUIT = "HOST HAS QUIT";
}
